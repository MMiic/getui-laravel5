...
namespace MMiic\GeTui\Protobuf;
use MMiic\GeTui\Protobuf\Encoding\Base128varint;
use MMiic\GeTui\Protobuf\Reader\PBInputStringReader;
use MMiic\GeTui\Protobuf\Type\PBInt;
use MMiic\GeTui\Protobuf\Type\PBString;
...
abstract class PBMessage
{
    ...
    private function getOriginClassName($className){
        ...
        $nss = [
            "App\\Services\\GeTui\\Protobuf\\Type\\",
            "App\\Services\\GeTui\\Igetui\\Reqs\\",
        ];
